...
const projects: Record<string, Project> = {
  ...
  "analytics-dashboard": {
    ...
    liveUrl: "https://laxmikant.yelgandrawar.com/Vessel-Performance-Dashboard/", // 👈 add your real link
  },
  "performance-report": {
      ...
      <div className="flex min-h-screen pt-16">
        ...
        <main className="flex-1 bg-[#0a0c10] min-h-screen relative overflow-x-hidden">
          ...
          <section className="py-12 px-4 md:px-8 lg:px-16">
            <div className="max-w-6xl mx-auto">
              <div className="relative bg-[#0d1017] border border-cyan-900/30 p-4">

                <div className="aspect-video bg-cyan-950/20 overflow-hidden">
                    ...
                    <>
                      ...
                      <div className="absolute bottom-4 right-4">
                        <Link
                          ...
                          target="_blank"
                          className="px-4 py-2 bg-cyan-400 text-black text-sm font-medium hover:bg-cyan-300 transition"
                        >
                          Open Live →
                        </Link>
                      </div>
          ...
          <section className="py-12 px-4 md:px-8 lg:px-16 bg-[#0d1017]">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-2xl font-bold mb-8 border-l-4 border-cyan-400 pl-4">
                Key Highlights
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {project.highlights.map((h, i) => (
                  <div
                    key={i}
                    className="flex gap-4 p-4 bg-[#0a0c10] border border-cyan-900/30"
                  >
                    <div className="w-8 h-8 flex items-center justify-center border border-cyan-400 text-cyan-400 text-sm">
          ...
          <section className="py-12 px-4 md:px-8 lg:px-16">
            <div className="max-w-6xl mx-auto">
              <div className="bg-cyan-950/10 border border-cyan-400/20 p-8">
                <p className="text-2xl">{project.impact}</p>
              </div>
            </div>
          </section>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="flex flex-wrap gap-3">
                {project.technologies.map((tech, i) => (
                  <span
                    key={i}
                    className="px-4 py-2 border border-cyan-900/30 text-slate-300 text-sm"
                  >
                    {tech}
                  </span>
                ))}
