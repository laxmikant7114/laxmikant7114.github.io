    ...
    <section className="relative min-h-[90vh] flex items-center px-4 md:px-8 lg:px-16 overflow-hidden border-b border-cyan-900/10">
      ...
      <div className="grid md:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10 w-full max-w-7xl mx-auto py-12">
        <div className="md:col-span-7 relative z-10">
          ...
          <h1 className="font-[family-name:var(--font-headline)] text-4xl md:text-54xl lg:text-7xl xl:text-7.5xl font-bold leading-[0.95] tracking-tighter mb-6 md:mb-8 text-foreground">
            Driving $1.2Million+ in <br />
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 md:gap-6">
            <a
              href="#methodology"
              className="bg-cyan-400 text-[#0a0c10] px-6 md:px-10 py-4 md:py-5 text-xs font-bold tracking-[0.2em] uppercase hover:bg-cyan-300 transition-all shadow-[0_0_30px_-5px_rgba(0,206,209,0.3)] active:scale-95 text-center"
            >
              Explore Methodology
            </a>
