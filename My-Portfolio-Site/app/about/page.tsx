...
const experience = [
  {
    title: "Data Analyst",
    company: "Gekko - Applied Drilling Intelligence",
  ...
  },
  {
    ...
    description: "Developed analytics dashboards for vessel performance monitoring and reporting.",
  },
]

const skills = [
  { icon: Code2, label: "Python & SQL", description: "Advanced data manipulation and analysis" },
  { icon: Database, label: "Data Engineering", description: "ETL pipelines and data warehousing" },
  { icon: LineChart, label: "Analytics", description: "Statistical modeling and visualization" },
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-slate-400 text-lg leading-relaxed mb-6">
                    I&apos;m <span className="text-cyan-400 font-bold">Laxmikant Yelgandrawar</span>, a Data Analyst specializing in industrial efficiency and optimization. With expertise in fuel prediction engines and performance analytics, I help organizations achieve significant cost savings through data-driven strategies.
                  </p>
                ...
                <div className="flex justify-center">
                  <div className="relative group">
                    ...
                    <div className="w-64 h-80 bg-cyan-950/20 border border-cyan-900/30 overflow-hidden">
                      <Image
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="relative pl-8 border-l-2 border-cyan-900/30">
                ...
                <p className="text-slate-400">
                  Specialized in Data Science and Analytics with focus on machine learning and statistical modeling.
                </p>
              </div>
            </div>
          </section>
